...
final class SpawnReplacementHandler {
    ...
    static void onEntityJoinLevel(EntityJoinLevelEvent event) {
        ...
        if (spawnType == null || !SpawnRestrictionRules.shouldReplace(mob, spawnType, level)) {
            return;
        }
    ...
    private static void spawnZombieReplacements(ServerLevelAccessor level, Mob source, EntitySpawnReason spawnType, DifficultyInstance difficulty) {
